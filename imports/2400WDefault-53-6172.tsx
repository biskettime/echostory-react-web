import svgPaths from "./svg-3c8wh35w53";
...
function Container1() {
  return (
    ...
    >
      ...
      <Margin1 />
      <div
        className="absolute bg-[#dc5903] bottom-[0.01px] h-[1.99px] left-[136.58px] w-[24.2px]"
...
function Paragraph() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal h-[22px] justify-center left-[9.19px] text-[13.125px] text-[rgba(255,255,255,0.85)] top-[10.63px] translate-y-[-50%] w-[36.5px]">
...
function Container14() {
  return (
    <div
      className="basis-0 grow h-[15.63px] min-h-px min-w-px shrink-0"
      data-name="Container"
    />
  );
}
...
function ComboboxListbox() {
  return (
    <div
      className="basis-0 box-border content-stretch flex flex-col grow h-full items-start justify-start min-h-px min-w-[4.1px] overflow-clip px-0 py-[4.18px] relative shrink-0"
...
function Container17() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-start justify-start max-w-[441.76px] min-h-6 pl-2 pr-0 py-0 relative shrink-0"
      data-name="Container"
    >
      <Container16 />
    </div>
...
function Container18() {
  return (
    <div
      className="[flex-flow:wrap] basis-0 box-border content-center flex gap-0 grow items-center justify-start max-w-[441.76px] min-h-px min-w-px p-0 relative self-stretch shrink-0"
      data-name="Container"
    >
      <Container17 />
    </div>
...
function Container19() {
  return (
    <div
      className="absolute bottom-[-4.13%] box-border content-stretch flex flex-col items-start justify-start left-2 overflow-clip p-0 right-[10.99px] top-[12.46%]"
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13.016px] text-[rgba(255,255,255,0.25)] text-left text-nowrap">
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row items-center justify-center pl-[3.625px] pr-[24.625px] py-[1.625px] relative size-full">
          <Container20 />
        </div>
      </div>
    </div>
...
function Container21() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row h-[11.99px] items-center justify-start p-0 right-[11px] top-1/2 translate-y-[-50%]"
      data-name="Container"
    >
      <Component6 />
    </div>
...
function Container24() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-center justify-center min-h-8 px-0 py-[0.38px] relative shrink-0 w-full"
      data-name="Container"
      style={{ marginBottom: "-7.10543e-15px" }}
    >
      <Container23 />
...
function Label3() {
  return (
    <div
      ...
      data-name="Label"
    >
      <div className="flex flex-col font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13.016px] text-[rgba(255,255,255,0.85)] text-left text-nowrap">
        <p className="block leading-[22px] whitespace-pre">
          세이프티 필터 설정
        </p>
      </div>
...
function Container35() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[11.063px] text-[rgba(255,255,255,0.5)] text-left w-full">
...
function BackgroundBorder3() {
  return (
    ...
    >
      ...
      />
      <div
        className="absolute bg-[#ffffff] left-1/2 rounded-2xl size-1.5 translate-x-[-50%] translate-y-[-50%]"
        data-name="Background"
        style={{ top: "calc(50% - 0.01px)" }}
      />
    </div>
  );
}
...
function Container39() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[13.945px] text-[rgba(255,255,255,0.85)] text-left text-nowrap">
...
function Label4() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row-reverse items-center justify-start left-0 p-0 top-[49.71px]"
      data-name="Label"
    >
      <Container38 />
      <Container39 />
...
function Container41() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Regular',_'Noto_Sans_KR:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14.18px] text-[rgba(255,255,255,0.85)] text-left text-nowrap">
...
function Label5() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row-reverse items-center justify-start left-0 pl-0 pr-[50.87px] py-0 top-[79.27px]"
      data-name="Label"
    >
      <Container40 />
      <Container41 />
...
function Container42() {
  return (
    <div
      className="basis-0 grow h-[108.83px] max-w-[470px] min-h-px min-w-px relative shrink-0"
      data-name="Container"
    >
      <Container37 />
      <Label4 />
...
function Background() {
  return (
    <div
      className="bg-[#1a1b1b] box-border content-stretch flex flex-col items-start justify-start max-w-[500px] pb-[193.1px] pt-0 px-0 relative shrink-0 w-[500px]"
      data-name="Background"
    >
