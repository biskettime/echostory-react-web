import svgPaths from "./svg-atk68p6tff";
...
function Container1() {
  return (
    ...
    >
      ...
      <Margin1 />
      <div
        className="absolute bg-[#dc5903] bottom-0 h-0.5 left-[56.2px] w-[48.4px]"
...
function Paragraph() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[22px] justify-center left-[9.2px] text-[13.125px] text-[rgba(255,255,255,0.85)] top-[11px] translate-y-[-50%] w-[48.6px]">
...
function Paragraph1() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[22px] justify-center left-[9.2px] text-[13.125px] text-[rgba(255,255,255,0.85)] top-[11px] translate-y-[-50%] w-[79.64px]">
...
function Textarea1() {
  return (
    <div
      className="basis-0 bg-[#3b3b3c] grow h-14 max-h-[140px] max-w-[446.5px] min-h-14 min-w-px relative rounded-xl shrink-0"
      data-name="Textarea"
    >
      <div className="max-h-inherit max-w-inherit min-h-inherit overflow-x-auto overflow-y-clip relative size-full">
...
function Container18() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row items-start justify-center pl-0 pr-[23.5px] py-0 relative w-full">
          <Container17 />
        </div>
      </div>
    </div>
...
function Container19() {
  return (
    <div
      className="basis-0 box-border content-stretch flex flex-col grow items-start justify-start max-w-[470px] min-h-px min-w-px pb-5 pt-1.5 px-0 relative shrink-0"
      data-name="Container"
    >
      <Container18 />
    </div>
...
function Background() {
  return (
    <div
      className="bg-[#1a1b1b] box-border content-stretch flex flex-col items-start justify-start max-w-[500px] pb-[281.2px] pt-0 px-0 relative shrink-0 w-[500px]"
