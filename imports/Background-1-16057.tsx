import svgPaths from "./svg-rw00wejl68";
...
function Overlay() {
  return (
    <div
      ...
      data-name="Overlay"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ff9000] text-[13.563px] text-left text-nowrap">
...
function Container1() {
  return (
    ...
    >
      ...
      <Margin1 />
      <div
        className="absolute bg-[#dc5903] bottom-0 h-0.5 left-0 w-[24.2px]"
...
function Input() {
  return (
    <div
      className="basis-0 box-border content-stretch flex flex-col grow items-start justify-start min-h-px min-w-px order-2 overflow-clip px-0 py-[2.5px] relative self-stretch shrink-0"
      data-name="Input"
    >
      <Container6 />
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-row-reverse items-start justify-start px-3 py-[5px] relative w-full">
          <Input />
          <Margin2 />
        </div>
      </div>
...
function Paragraph1() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[22px] justify-center left-[9.2px] text-[13.125px] text-[rgba(255,255,255,0.85)] top-[11px] translate-y-[-50%] w-[64.12px]">
...
function Container12() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[14.4px] not-italic relative shrink-0 text-[11.25px] text-[rgba(255,255,255,0.5)] text-left text-nowrap whitespace-pre">
...
function Container13() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-[3.45px] items-start justify-start pb-1 pt-0 px-0 relative shrink-0"
      data-name="Container"
    >
      <Paragraph1 />
      <Container12 />
...
function Container15() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[21px] not-italic relative shrink-0 text-[13.125px] text-[rgba(255,255,255,0.25)] text-left w-full">
...
function Container16() {
  return (
    <div
      className="absolute bottom-[-21px] box-border content-stretch flex flex-col items-start justify-start p-0 right-[0.58px]"
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13.344px] text-[rgba(255,255,255,0.45)] text-left text-nowrap">
...
function Container19() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-start justify-start left-0 p-0 right-0 top-[109.4px]"
      data-name="Container"
...
function Container27() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-center justify-center mb-[-0.01px] min-h-8 p-0 relative shrink-0 w-full"
      data-name="Container"
    >
      <Container26 />
    </div>
...
function Container28() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-start justify-start left-0 pb-[0.01px] pt-0 px-0 right-0 top-[316.2px]"
      data-name="Container"
    >
      <Container23 />
      <Container27 />
...
function Container29() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-center justify-start left-[19.83px] px-4 py-0 translate-y-[-50%]"
      data-name="Container"
...
function Separator() {
  return (
    <div
      className="absolute h-[25.14px] left-0 right-0 top-[465.59px]"
      data-name="Separator"
    >
      <Container29 />
      <div
        className="absolute h-px left-0 right-[95.78%] translate-y-[-50%]"
        data-name="Horizontal Divider"
        style={{ top: "calc(50% + 0.5px)" }}
      >
        <div
          aria-hidden="true"
          className="absolute border-[1px_0px_0px] border-[rgba(253,253,253,0.01)] border-solid inset-0 pointer-events-none"
        />
      </div>
      <div
        className="absolute h-px left-[19.85%] right-0 translate-y-[-50%]"
        data-name="Horizontal Divider"
        style={{ top: "calc(50% + 0.5px)" }}
      >
        <div
...
function Container33() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13.234px] text-[rgba(255,255,255,0.25)] text-left w-full">
...
function Container34() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[13.234px] text-[rgba(255,255,255,0.45)] text-left text-nowrap">
...
function Container42() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[21px] not-italic relative shrink-0 text-[13.234px] text-[rgba(255,255,255,0.25)] text-left w-full">
...
function Container47() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-6 items-start justify-start left-0 p-0 right-0 top-[498.73px]"
      data-name="Container"
    >
      <Container38 />
      <Container46 />
...
function Container48() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-center justify-start left-[17.55px] px-4 py-0 translate-y-[-50%]"
      data-name="Container"
      style={{ top: "calc(50% + 0.43px)" }}
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-[rgba(255,255,255,0.85)] text-center text-nowrap">
...
function Separator1() {
  return (
    <div
      className="absolute h-[25.14px] left-0 right-0 top-[758.53px]"
      data-name="Separator"
    >
      <Container48 />
      <div
        className="absolute h-px left-0 right-[96.27%] translate-y-[-50%]"
        data-name="Horizontal Divider"
        style={{ top: "calc(50% + 0.5px)" }}
      >
        <div
      ...
      <div
        className="absolute h-px left-[29.03%] right-0 translate-y-[-50%]"
        data-name="Horizontal Divider"
        style={{ top: "calc(50% + 0.5px)" }}
      >
        <div
...
function Container49() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[18.86px] not-italic relative shrink-0 text-[11.25px] text-[rgba(255,255,255,0.5)] text-left w-full">
        <p className="block mb-0">
...
function ImgPicture() {
  return (
    <div
      className="bg-[rgba(255,255,255,0.3)] box-border content-stretch flex flex-row items-center justify-center p-0 relative rounded-2xl shrink-0 size-8"
...
function Container50() {
  return (
    <div
      className="box-border content-stretch flex flex-row items-center justify-center px-0 py-[102.5px] relative shrink-0"
      data-name="Container"
    >
      <ImgPicture />
    </div>
...
function Background() {
  return (
    <div
      className="basis-0 bg-[#ff9000] box-border content-stretch flex flex-row grow items-center justify-center min-h-px min-w-px px-0 py-2 relative rounded-lg self-stretch shrink-0"
      data-name="Background"
    >
      <div className="basis-0 flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[13.125px] text-[rgba(255,255,255,0.85)] text-center">
...
function Overlay1() {
  return (
    <div
      className="basis-0 bg-[rgba(255,255,255,0.1)] box-border content-stretch flex flex-row grow items-center justify-center min-h-px min-w-px px-0 py-2 relative rounded-lg self-stretch shrink-0"
      data-name="Overlay"
    >
      <div className="basis-0 flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[13.125px] text-[rgba(255,255,255,0.85)] text-center">
...
function Margin4() {
  return (
    <div
      className="box-border content-stretch flex flex-col h-[103px] items-start justify-end min-h-[88px] pb-[15px] pt-0 px-0 relative shrink-0"
      data-name="Margin"
    >
      <Container53 />
    </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div
          className="box-border content-stretch flex flex-col items-center justify-start p-px relative w-full"
...
function Container56() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-[12.01px] items-start justify-start left-0 p-0 right-0 top-[791.67px]"
      data-name="Container"
    >
      <Container49 />
      <Container55 />
...
function Tabpanel() {
  return (
    <div
      className="h-[1183.38px] relative shrink-0 w-full"
      data-name="Tabpanel"
    >
      <Container11 />
      <Container19 />
...
function Container57() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start order-1 pb-5 pt-0 px-0 relative shrink-0 w-full"
      data-name="Container"
    >
      <Tabpanel />
    </div>
