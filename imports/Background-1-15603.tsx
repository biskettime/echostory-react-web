import svgPaths from "./svg-n9slw1jir3";
import imgDiscordIconPng from "figma:asset/b686731a73383e744f82f20d1a694b0cfbc6c2e4.png";
import imgThumbnail from "figma:asset/5e4363550d7d2c0289dd5b1b20e8678edaef6fa0.png";
import imgThumbnail1 from "figma:asset/810773b3211283d0d105e5a4b74c9236fddaf975.png";
...
function Component12() {
  return (
    <div
      className="bg-[#373737] relative shrink-0 w-full"
...
function Background1() {
  return (
    <div
      className="bg-[#282828] box-border content-stretch flex flex-col items-start justify-start overflow-clip pb-0 pt-[5px] px-0 relative rounded-[5px] shrink-0 w-full"
      data-name="Background"
    >
      <Component3 />
      <Component7 />
...
function Container17() {
  return (
    <div
      className="box-border content-stretch flex flex-col items-start justify-start overflow-clip p-0 relative self-stretch shrink-0 w-[318px]"
      data-name="Container"
    >
...
function Container19() {
  return (
    <div
      className="h-[32.39px] overflow-clip relative shrink-0 w-full"
      data-name="Container"
    >
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.85px] translate-y-[-50%] w-[344.02px]">
        <p className="block mb-0">
          *낮게 읊조리며 지우의 굳은 얼굴을 쓰다듬는다.* 기다렸어, 이 대답.
          *셔츠
        </p>
        <p className="block">
          단추를 하나 더 풀고, 지우의 뺨에 손을 가져다 댄다. 묘하게 젖은 눈빛으
        </p>
      </div>
    </div>
  );
...
function Container20() {
  return (
    <div
      className="absolute bottom-[8.1px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[102.98px]"
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap">
...
function Link1() {
  return (
    <div className="relative rounded-lg shrink-0 w-full" data-name="Link">
      ...
      />
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-row items-start justify-start p-px relative w-full">
          <Thumbnail />
          <Container21 />
        </div>
      </div>
...
function Container24() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[7.75px] translate-y-[-50%] w-[317.38px]">
...
function Container25() {
  return (
    <div
      className="absolute bottom-[8.1px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[103.2px]"
      data-name="Container"
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap">
        <p className="block leading-[18.86px] whitespace-pre">
...
function Container31() {
  return (
    <div
      className="min-h-[831px] relative shrink-0 w-full"
      data-name="Container"
    >
...
function Container34() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-start justify-start left-[15px] p-0 right-[15px] top-[83.5px]"
      data-name="Container"
    >
...
function Container37() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-[15px] items-start justify-start min-h-[831px] p-0 relative shrink-0 w-full"
      data-name="Container"
    >
      <Container31 />
      <HorizontalBorder />
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 103 25"
      >
        <g clipPath="url(#clip0_1_15607)" id="Component 2">
          <path
