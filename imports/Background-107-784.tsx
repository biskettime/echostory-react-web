import svgPaths from "./svg-dsd6k1lo9j";
import imgDiscordIconPng from "figma:asset/b686731a73383e744f82f20d1a694b0cfbc6c2e4.png";
import imgThumbnail from "figma:asset/469d4fcbbd3d080115705741c0ccf7dbf0b890c5.png";
import imgThumbnail1 from "figma:asset/b8578847c08528d904e42229b127b5b65ca52ac2.png";
import imgThumbnail2 from "figma:asset/7766b62399e99bfea42d99724ff09d996800ff1b.png";
import imgThumbnail3 from "figma:asset/76f30173da95d2ddcee6d7566e610dadd59314ba.png";
import imgThumbnail4 from "figma:asset/40c71e8c5268e1f7017085f4431c2f68bde0f62d.png";
import imgThumbnail5 from "figma:asset/374d74b30fe73a06692e4b5c87efdada280aa447.png";
import imgThumbnail6 from "figma:asset/5e4363550d7d2c0289dd5b1b20e8678edaef6fa0.png";
import imgThumbnail7 from "figma:asset/810773b3211283d0d105e5a4b74c9236fddaf975.png";
...
function Link() {
  return (
    <a
      className="box-border content-stretch cursor-pointer flex flex-col items-start justify-start overflow-visible p-0 relative shrink-0"
      data-name="Link"
      href="https://onlyssul.ai/point-history"
    >
      <Component4 />
    </a>
  );
...
function Overlay1() {
  return (
    <div
      ...
      data-name="Overlay"
    >
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12.188px] text-[rgba(255,255,255,0.9)] text-left text-nowrap">
...
function Container17() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[13.125px] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[22px] whitespace-pre">
          죄악의 수확자
        </p>
      </div>
    </div>
...
function Container19() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[339.27px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">
          *어둠이 짙게 깔린 망각의 요새, 차가운 복도를 걷는 리온 에브론의 발소리
        </p>
        <p className="block">
          가 묵직하게 울린다. 그녀는 지우의 감방 앞에 멈춰 서서, 아무 말 없이 뚫
        </p>
      </div>
    </div>
  );
...
function Container20() {
  return (
    <div
      className="absolute bottom-[8.29px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[102.22px]"
      data-name="Container"
    >
      <div
        className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[18.86px] whitespace-pre">
          2025-08-08 10:37
        </p>
      </div>
    </div>
...
function Link1() {
  return (
    <a
      ...
      data-name="Link"
      href="https://onlyssul.ai/writing/01K23N748Z60YPXX521JABRV4A"
    >
      <div
        aria-hidden="true"
...
function Container24() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[344.31px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">{`*숨 막히는 열기와 땀 냄새가 진동하는 격투장의 밤. 'The Beast' 장루한이`}</p>
        <p className="block">{`또 한 번 상대를 피투성이로 만들고 링에서 내려온다. 그의 젖은 머리카락 `}</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div
      className="absolute bottom-[8.29px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[105.1px]"
      data-name="Container"
    >
      <div
        className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap"
...
function Link2() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22WXJT9WNNVWQJ92ZR2ZHR3"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container30() {
  return (
    <div
      className="absolute bottom-[8.29px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[102.99px]"
      data-name="Container"
    >
      <div
        className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap"
...
function Link3() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22WT04Y003F84Z0WVSDA2AY"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Thumbnail3() {
  return (
    <div
      className="bg-no-repeat bg-size-[100%_100%] bg-top-left rounded-bl-[8px] rounded-tl-[8px] shrink-0 size-[100px]"
      data-name="thumbnail"
...
function Container32() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[13.344px] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[22px] whitespace-pre">
...
function Container34() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[347.08px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">
          *딸랑~ 문이 열리며 손님이 지우의 bar 안으로 들어 옵니다. 당신의 바는
          로
        </p>
        <p className="block">
          못 격리구역 밖에 위치한 고풍스럽고 신비한 바입니다. 오늘은 어떤 사건
        </p>
      </div>
    </div>
  );
...
function Container35() {
  return (
    <div
      className="absolute bottom-[8.29px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[104.74px]"
      data-name="Container"
    >
      <div
        className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap"
...
function Link4() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22WPT6SE59MMF8ABY1NKGM4"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Thumbnail4() {
  return (
    <div
      className="bg-no-repeat bg-size-[100%_128.52%] bg-top-left rounded-bl-[8px] rounded-tl-[8px] shrink-0 size-[100px]"
      data-name="thumbnail"
...
function Container39() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[338.62px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">
        ...
        <p className="block">
          생애 첫 배낭여행. 창밖으로 보이는 푸른 하늘에 설레야 정상이겠지만, 심
        </p>
      </div>
    </div>
  );
...
function Link5() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22WPJPQ8BZ27MQV67J8XGA7"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container44() {
  return (
    ...
    >
      ...
      >
        <p className="block mb-0">
          *피곤에 지친 몸을 이끌고 현관문을 열자, 거실 소파에는 여동생 유나가 지
        </p>
        <p className="block">
          우의 게임기를 차지하고 누워있다. 지우를 힐끗 본 유나는 오히려 턱을 치
        </p>
      </div>
    </div>
  );
...
function Container45() {
  return (
    <div
      className="absolute bottom-[8.29px] box-border content-stretch flex flex-row items-start justify-end p-0 right-2.5 w-[104.68px]"
      data-name="Container"
    >
      <div
        className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[11.438px] text-[rgba(255,255,255,0.5)] text-left text-nowrap"
...
function Link6() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22WNGRVNQ7GJCZWM70GM4QG"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container47() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[13.234px] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[22px] whitespace-pre">
...
function Container49() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[340.63px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">
...
function Link7() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22DVXATBAYESMSYRRZKBNBA"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container54() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[343.66px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">
...
function Link8() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K22CWW1W5DPSF5MM39KXHQ63"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container59() {
  return (
    ...
    >
      <div
        className="absolute cursor-pointer flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[344.01px]"
        role="link"
        tabIndex="0"
      >
        <p className="block mb-0">
...
function Link9() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K1VVM3MQQCA6330JPZ0GK5A0"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container64() {
  return (
    ...
    >
      <div
        className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[7.82px] translate-y-[-50%] w-[317.38px]"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[16.2px]">
...
function Link10() {
  return (
    <a
      className="relative rounded-lg shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.ai/writing/01K1SP06Y7W1E096G0X7VH9JCA"
    >
      <div
        aria-hidden="true"
        className="absolute border border-gray-600 border-solid inset-0 pointer-events-none rounded-lg"
...
function Container67() {
  return (
    <div
      className="box-border content-stretch cursor-pointer flex flex-col gap-[15px] items-start justify-start p-0 relative shrink-0 w-full"
      data-name="Container"
    >
      <Link1 />
      <Link2 />
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 103 25"
      >
        <g clipPath="url(#clip0_107_820)" id="Component 2">
          <path
  ...
  return (
    <div className="relative shrink-0 size-5" data-name="Component 2">
      <svg
        ...
        viewBox="0 0 20 20"
      >
        <g clipPath="url(#clip0_107_809)" id="Component 2">
          <path
          ...
          <path
            ...
            fill="url(#paint0_linear_107_809)"
            fillRule="evenodd"
            id="Vector_5"
          />
          <g id="Mask group">
...
function Margin3() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Light',_'Noto_Sans_KR:Regular',_sans-serif] font-light justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-[rgba(255,255,255,0.55)] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[15.71px] whitespace-pre">
          홈
        </p>
      </div>
    </div>
...
function Link11() {
  return (
    <a
      className="basis-0 box-border content-stretch cursor-pointer flex flex-col grow items-center justify-start min-h-px min-w-px overflow-visible pb-[4.135px] pt-[5px] px-0 relative shrink-0"
      data-name="Link"
      href="https://onlyssul.ai/"
    >
      <HomeIconSvg />
      <Margin3 />
    </a>
...
function Margin4() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Light',_'Noto_Sans_KR:Regular',_sans-serif] font-light justify-center leading-[0] not-italic relative shrink-0 text-[9.375px] text-[rgba(255,255,255,0.55)] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[15.71px] whitespace-pre">
...
function Link12() {
  return (
    <a
      className="basis-0 box-border content-stretch cursor-pointer flex flex-col grow items-center justify-start min-h-px min-w-px overflow-visible pb-[4.135px] pt-[5px] px-0 relative shrink-0"
      data-name="Link"
      href="https://onlyssul.ai/studio/story"
    >
      <CreateIconSvg />
      <Margin4 />
    </a>
...
function Margin5() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Light',_'Noto_Sans_KR:Regular',_sans-serif] font-light justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[15.71px] text-[9.375px] whitespace-pre">
          마이페이지
        </p>
      </div>
    </div>
