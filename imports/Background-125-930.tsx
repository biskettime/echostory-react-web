import svgPaths from "./svg-ln3d37d4yi";
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 103 25"
      >
        <g clipPath="url(#clip0_125_934)" id="Component 1">
          <path
...
export default function Background3() {
  return (
    <div
      className="bg-[#1a1b1b] box-border content-stretch flex flex-col items-start justify-start p-0 relative size-full"
      data-name="Background"
    >
      <Background2 />
      <Background1 />
