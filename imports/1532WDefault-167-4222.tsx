import svgPaths from "./svg-qoakny5u4t";
...
function Overlay() {
  return (
    ...
    >
      <div
        className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ff9500] text-[13.563px] text-left text-nowrap"
        role="link"
        tabIndex="0"
      >
        <p className="block cursor-pointer leading-[22px] whitespace-pre">{`스토리 제작 가이드 `}</p>
      </div>
      <ImgExport />
    </div>
  );
...
function Link() {
  return (
    <a
      className="box-border content-stretch cursor-pointer flex flex-row items-start justify-center overflow-visible p-0 relative shrink-0 w-full"
      data-name="Link"
      href="https://onlyssul.gitbook.io/only-ssul/getting-started/v2"
    >
      <Container />
    </a>
  );
...
function Paragraph() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[22px] justify-center left-[9.19px] text-[13.125px] text-[rgba(255,255,255,0.85)] top-[10.63px] translate-y-[-50%] w-[36.5px]">
...
function Container7() {
  return (
    <div
      className="absolute bottom-[-21.36px] box-border content-stretch flex flex-col items-start justify-start p-0 right-[0.56px]"
      data-name="Container"
    >
...
function Paragraph1() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[22px] justify-center left-[9.19px] text-[13.234px] text-[rgba(255,255,255,0.85)] top-[10.63px] translate-y-[-50%] w-[24.4px]">
...
function BackgroundHorizontalBorder() {
  return (
    <div
      className="absolute bg-[#1a1b1b] box-border content-stretch flex flex-row gap-[316.92px] h-10 items-center justify-start left-[516.25px] max-w-[500px] pb-[0.625px] pl-0 pr-[15px] pt-0 top-0 w-[500px]"
