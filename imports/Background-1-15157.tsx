import svgPaths from "./svg-vecoslfutg";
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 103 25"
      >
        <g clipPath="url(#clip0_1_15161)" id="Component 2">
          <path
