import svgPaths from "./svg-knzzxnb4ni";
...
function Container19() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[33px] justify-center leading-[16.2px] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[15.91px] translate-y-[-50%] w-[344.01px]">
...
function Container24() {
  return (
    <div
      ...
      data-name="Container"
    >
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] left-0 not-italic text-[11.25px] text-[rgba(255,255,255,0.5)] text-left top-[7.82px] translate-y-[-50%] w-[317.38px]">
  ...
  return (
    ...
    >
      <div className="min-h-inherit relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[15px] items-start justify-start min-h-inherit pb-[228.44px] pt-[55px] px-[15px] relative w-full">
          <Container3 />
          <Background />
          <Background1 />
          <Container28 />
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 103 25"
      >
        <g clipPath="url(#clip0_38_1077)" id="Component 2">
          <path
  ...
  return (
    <div className="relative shrink-0 size-5" data-name="Component 2">
      <svg
        ...
        viewBox="0 0 20 20"
      >
        <g clipPath="url(#clip0_38_1057)" id="Component 2">
          <path
          ...
          <path
            ...
            fill="url(#paint0_linear_38_1057)"
            fillRule="evenodd"
            id="Vector_5"
          />
          <g id="Mask group">
