import svgPaths from "./svg-s4c10pbjqx";
...
function Paragraph1() {
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium h-[22px] justify-center left-[9.19px] text-[13.125px] text-[rgba(255,255,255,0.85)] top-[10.63px] translate-y-[-50%] w-[64.12px]">
...
function BackgroundHorizontalBorder() {
  return (
    <div
      className="absolute bg-[#1a1b1b] box-border content-stretch flex flex-row h-10 items-center justify-between left-[516.25px] max-w-[500px] pb-[0.625px] pl-0 pr-[15px] pt-0 top-0 w-[500px]"
