import svgPaths from "./svg-dzkl73gmd9";
...
function Container23() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-center justify-start left-0 overflow-auto pb-[479.29px] pt-2.5 px-0 top-[-1471.37px] w-[2400px]"
      data-name="Container"
    >
      <Dialog />
    </div>
...
export default function Container24() {
  return (
    <div className="relative size-full" data-name="Container">
      <div
        className="absolute bg-[rgba(0,0,0,0.45)] h-[1038.75px] left-0 top-[-1471.37px] w-[2400px]"
        data-name="Overlay"
      />
      <Container23 />
    </div>
