export const en = {
  ...
  chat: {
    ...
    cancel: 'Cancel',
    save: 'Save',
    response1: '*I see what you mean.* !The character nods thoughtfully, showing genuine interest in your words.!',
    response2: '"That\'s quite interesting." *leans forward with curiosity* !Their eyes light up as they process what you\'ve shared.!',
    response3: '"Could you tell me more about that?" !The character tilts their head slightly, encouraging you to continue.! *I\'d love to hear more details.*',
    response4: '*I understand that must have been difficult.* "Thank you for sharing that with me." !They offer a sympathetic smile.!',
    response5: '"What are your thoughts on it?" *genuinely curious about your perspective* !The character waits attentively for your response.!',
